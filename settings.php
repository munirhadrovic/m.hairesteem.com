<?php
	$adresa="Hair Esteem Inc 372 5th Ave South, Naples, Florida 34102 "; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=2392628845;// Broj koji se poziva na dugme CALL US
